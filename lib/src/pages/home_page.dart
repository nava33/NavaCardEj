      ...
      child: Column(
        children: <Widget>[
          ListTile(
            ...
            title: Text('Titulo'),
            subtitle: Text('Este es el subtitulo del card. Aqui podemos colocar descripción de este card.'),
  ...
  Card miCardImageCarga() {
    return Card(
      ...
      child: Column(
        children: <Widget>[
          FadeInImage(
            image: NetworkImage('https://staticuestudio.blob.core.windows.net/buhomag/2016/03/01195417/pexels-com.jpg'),
